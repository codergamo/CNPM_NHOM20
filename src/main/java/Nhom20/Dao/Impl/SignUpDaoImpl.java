...
public class SignUpDaoImpl extends DBConnect implements ISignUpDao{
	@Override
	public void insert(SignUpModel signup) {
		...
		try {
			...
			/*
			 * ps.setTimestamp(1, signup.getStartTime()); ps.setTimestamp(2,
			 * signup.getEndTime()); ps.setBoolean(3, signup.getRole()); ps.executeUpdate();
			 */
		} catch (Exception e) {
			e.printStackTrace();
		}
