                            ...
                            <div id="desktop-menu">
                                <div class="panel panel-default">
                                    <div class="panel-heading" style = 'text-align: center;background: #a9bffd;'>
                                        <h4 id="mobile_home"><b>Danh Mục</b></h4>
                                    </div>
                                    
                                    <a href="${link}" class="list-group-item"><img src="<c:url value="/Content/public/images/house-icon.png"/>" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Trang Chủ</a>
                                    <a href="./list-topic" class="list-group-item "><img src="<c:url value="/Content/public/images/Actions-view-calendar-list-icon.png"/>" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Danh sách đề tài</a>
                                    <a href="${link }/RegistrationInstructions" class="list-group-item "><img src="<c:url value="/Content/public/images/Actions-help-contents-icon.png"/>" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Hướng dẫn đăng ký</a>
