                        ...
                        <div class="col-md-3">
                            ...
                            <div id="desktop-menu">
                                <div class="panel panel-default">
                                    ...
                                    <a href="./RegistrationInstructions" class="list-group-item "><img src="<c:url value="/Content/public/images/Actions-help-contents-icon.png"/>" width="24" height="24" /><span class="pull-right"><i class="icon-chevron-right"></i></span> Hướng dẫn đăng ký</a>
