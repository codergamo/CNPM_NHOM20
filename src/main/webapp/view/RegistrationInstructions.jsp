...
<body>
	<div class="col-md-9">
		<div class="well-sm">
			<span> 
					<img src="<c:url value="/Content/public/images/bullet-blue-icon.png"/>" > <small>
			...
			<div class="panel-body">
				...
				<p style="text-align: center;">
					<img class="img-thumbnail img-responsive" alt="Username password"
						src="<c:url value="/Content/public/images/DN.png"/>" 
				...
				<p style="text-align: center;">
					...
					src="<c:url value="/Content/public/images/cn_sv.png"/>" >
				</p>
				<p>&nbsp;</p>
